...
RSpec.describe do
  describe '#simulator' do
    ...
    context '入力値が正常系の場合' do
      ...
      it '結果が出力されること' do
        result = [
          { provider_name: '東京ガス', plan_name: 'ずっとも電気１', price: 10_793 },
          { provider_name: '東京電力エナジーパートナー', plan_name: '従量電灯B', price: 11_353 },
          { provider_name: 'Loopでんき', plan_name: 'おうちプラン', price: 10_560 },
          { provider_name: 'JXTGでんき', plan_name: 'たっぷりプラン', price: 10_804 }
        ]
