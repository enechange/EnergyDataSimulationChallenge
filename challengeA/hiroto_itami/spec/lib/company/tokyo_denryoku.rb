...
RSpec.describe do
  describe '#simulate_list' do
    subject { Company::TokyoDenryoku.new(ampere: ampere, watt: watt).simulate_list }
    ...
    context "契約可能なアンペア数の場合" do
      ...
      context "15A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 10638 }]
        end
      end
      ...
      context "20A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 10781 }]
        end
      end
      ...
      context "30A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 11067 }]
        end
      end
      ...
      context "40A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 11353 }]
        end
      end
      ...
      context "50A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 11639 }]
        end
      end
      ...
      context "60A, 400kWh" do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: "東京電力エナジーパートナー", plan_name: "従量電灯B", price: 11925 }]
        end
      end
    end
  end
