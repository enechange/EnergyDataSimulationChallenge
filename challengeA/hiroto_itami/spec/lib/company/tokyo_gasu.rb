...
RSpec.describe do
  describe '#simulate_list' do
    subject { Company::TokyoGasu.new(ampere:, watt:).simulate_list }
    ...
    context '契約可能なアンペア数の場合' do
      context '30A' do
        ...
        context '999_999_999_999kWh' do
          ...
          it do
            ...
            is_expected.to eq [{ provider_name: '東京ガス', plan_name: 'ずっとも電気１', price: 26_409_999_999_916 }]
          end
        end
      end
      ...
      context '40A, 400kWh' do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: '東京ガス', plan_name: 'ずっとも電気１', price: 10_793 }]
        end
      end
      ...
      context '50A, 400kWh' do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: '東京ガス', plan_name: 'ずっとも電気１', price: 11_079 }]
        end
      end
      ...
      context '60A, 400kWh' do
        ...
        it do
          ...
          is_expected.to eq [{ provider_name: '東京ガス', plan_name: 'ずっとも電気１', price: 11_365 }]
        end
      end
    end
  end
