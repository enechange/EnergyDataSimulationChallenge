    ...
    context "30Aの場合" do
      it "30A/120kWhの場合、配列数4つ" do
        ...
        expect(simulator.simulate).to contain_exactly(
          ...
          {:provider_name=>"JXTGでんき", :plan_name=>"従量電灯B たっぷりプラン", :price=>"3243"}
        )
      end
      ...
      it "30A/400kWhの場合、配列数4つ" do
        ...
        expect(simulator.simulate).to contain_exactly(
          ...
          {:provider_name=>"JXTGでんき", :plan_name=>"従量電灯B たっぷりプラン", :price=>"10518"}
        )
      end
    end

    context "40Aの場合" do
      it "40A/120kWhの場合、配列数4つ" do
        ...
        expect(simulator.simulate).to contain_exactly(
          ...
          {:provider_name=>"JXTGでんき", :plan_name=>"従量電灯B たっぷりプラン", :price=>"3529"}
        )
      end
      ...
      it "40A/400kWhの場合、配列数4つ" do
        ...
        expect(simulator.simulate).to contain_exactly(
          ...
          {:provider_name=>"JXTGでんき", :plan_name=>"従量電灯B たっぷりプラン", :price=>"10804"}
        )
      end
    end
  end
