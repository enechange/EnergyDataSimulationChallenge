...
class EnergiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create energy" do
    assert_difference('Energy.count') do
      post energies_url, params: { energy: { daylight: @energy.daylight, energy_production: @energy.energy_production, label: @energy.label, month: @energy.month, temperature: @energy.temperature, year: @energy.year } }
    end
  ...
  test "should update energy" do
    patch energy_url(@energy), params: { energy: { daylight: @energy.daylight, energy_production: @energy.energy_production, label: @energy.label, month: @energy.month, temperature: @energy.temperature, year: @energy.year } }
