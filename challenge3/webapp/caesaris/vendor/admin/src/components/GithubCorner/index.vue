<template lang="pug">
  a.github-corner(v-if='url', :href='url', target='_blank', aria-label='View source on Github')
    svg(:width='size', :height='size', viewBox='0 0 250 250', style='fill:#40c9c6; color:#fff;', aria-hidden='true')
...
export default class GithubCorner extends Vue {
  ...
  @Prop({ default: 80 }) private size!: string | number;
}
</script>
